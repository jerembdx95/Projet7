...
exports.createArticle = (req, res, next) => {
  ...
  const queryString = "INSERT INTO Articles (name, description, id_user) VALUES (?, ?, ?)";
  const inserts = [name, description, id_user];
...
exports.getAllArticles = (req, res, next) => {
  const queryString = "SELECT articles.id, name, description, u.firstname AS firstname, u.lastname AS surname, id_user, date FROM Articles INNER JOIN Users u ON Articles.id_user = u.id ";
